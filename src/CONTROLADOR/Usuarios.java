...
public class Usuarios {
	...
	public boolean obtenerUsuario_Do(String usu, String contra) {

		boolean respuesta = false;
		String sentencia = "select * from usuarios_login as u where u.id_usuario='" + usu + "' and u.contrasenia='"
				+ contra + "' and role = 'docente';";
		System.out.print(sentencia);
		try {
			ResultSet rs;
			Conexion clsCon = new Conexion();
	...
	public boolean obtenerUsuario_Di(String usu, String contra) {

		boolean respuesta = false;
		String sentencia = "select * from usuarios_login as u where u.id_usuario='" + usu + "' and u.contrasenia='"
				+ contra + "' and role = 'director';";
		System.out.print("BIENVENIDO");
		try {
			ResultSet rs;
			Conexion clsCon = new Conexion();
